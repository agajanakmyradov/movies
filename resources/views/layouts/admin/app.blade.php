...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand  navbar-secondary px-4">
        <!-- Right navbar links -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index3.html" class="brand-link" style="100%">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="{{route('genres.index')}}" class="nav-link ">
                ...
                <span class="mx-2 align-middle">Genres</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{route('movies.index')}}" class="nav-link ">
                ...
                <span class="mx-2 align-middle">Movies</span>
            </a>
          </li>
        </ul>
      </nav>
